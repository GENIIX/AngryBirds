...
function draw() {
    ...
    if (level === 2) {
        if (create = true) {
            ground.recreate(600, height, 1200, 20);
            // platform = new Ground(150, 305, 300, 170);

            box1.recreate(700, 320, 70, 70);
            box2.recreate(920, 320, 70, 70);
            pig1=new Pig(810, 350);
            log1.recreate(810, 260, 300, PI / 2);

            box3.recreate(700, 240, 70, 70);
            box4.recreate(920, 240, 70, 70);
            pig3=new Pig(810, 220);

            log3.recreate(810, 180, 300, PI / 2);

            box5.remove()
          //  box5 = null;
            // box5.recreate (810,160,70,70);
            log4.recreate(760, 120, 150, PI / 7);
            log5.recreate(870, 120, 150, -PI / 7);
 
            bird.recreate(200, 220);
            bird2.recreate(200, 50)
            //log6 = new Log(230,180,80, PI/2);
            slingshot.recreate(bird.body, { x: 200, y: 50 + 170 });
            create = false;
        }
